...
@call SET SRCFILES="%BAT_PATH%src/shared/*.cpp" "%BAT_PATH%src/shared/world/*.cpp" "%BAT_PATH%src/client/*.cpp" "%BAT_PATH%src/client/components/*.cpp" "%BAT_PATH%src/client/components/graphics/*.cpp" "%BAT_PATH%src/client/components/graphics/models/*.cpp"
...
@call echo --------------------------COMPILING--------------------------
if "%DEBUG%"=="" (
@call cl /analyze- /c /Ox /GL /MD /MP /DPLATFORM_WIN /DWIN32 /D_USING_V110_SDK71_ %ISVS15% -I%SDL_INC% /fp:fast /EHsc %SRCFILES%
) else (
@call mkdir debug
@call cd debug
@call echo --------------------------DEBUG--------------------------
@call cl /analyze- /c /Od /ZI /Gm /MDd /MP /DPLATFORM_WIN /DWIN32 /D_USING_V110_SDK71_ %ISVS15% -I%SDL_INC% /fp:precise /EHsc %SRCFILES%
)
