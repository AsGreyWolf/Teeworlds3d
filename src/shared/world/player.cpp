...
player &player::operator=(const player &p) {
	...
	dir = p.dir;
	jumped = p.jumped;
	hook_state = p.hook_state;
	hook_pos = p.hook_pos;
	hook_dir = p.hook_dir;
	hooked_player = p.hooked_player;
...
// 		return;
// 	}
// 	float tuning_gravity = 0.5f; // TODO: tuning
// 	float tuning_ground_speed = 10.0f;
// 	float tuning_air_speed = 5.0f;
// 	float tuning_ground_accel = 2.0f;
// 	float tuning_air_accel = 1.5f;
// 	float tuning_ground_friction = 0.5f;
// 	float tuning_air_friction = 0.95f;
// 	float tuning_velramp_start = 550;
// 	float tuning_velramp_range = 2000;
// 	float tuning_velramp_curvature = 1.4f;
// 	bool tuning_player_colision = true;
// 	float tuning_ground_jump_impulse = 13.2f;
// 	float tuning_air_jump_impulse = 12.0f;
// 	float tuning_hook_length = 380.0f;
// 	float tuning_hook_fire_speed = 80.0f;
// 	float tuning_hook_drag_accel = 3.0f;
// 	float tuning_hook_drag_speed = 15.0f;
// 	bool tuning_player_hooking = true;
//
