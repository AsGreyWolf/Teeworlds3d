...
projectile::projectile(const vec3 &pos, const rot3 &rot, weapon_t type,
                       duration_t life, player_id_t owner, int damage,
                       weapon_t weapon, bool explosive, float force,
                       sound_t sound) {
	this->pos = pos;
	this->rot = rot;
	this->type = type;
...
// 	    g_World()->IntersectPlayer(prevPos, curPos, &curPos, nullptr, owner,
// 6.0f);
// 	life--;
...
// 		// m_Weapon, false);
// 		// TODO:40 else if (TargetChr) TargetChr->TakeDamage(m_Direction *
// max(0.001f,
