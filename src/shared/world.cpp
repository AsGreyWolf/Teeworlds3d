...
world_component::world_component() : component(){};
...
// 		float c = pow(glm::length(tee), 2.0f) - pow(p->physSize / 2 + radius,
// 2.0f);
...
// 	Tile *buf = GetTile(glm::vec3(pos.x - Size.x, pos.y - Size.y, pos.z -
// Size.z));
// 	if ((buf != nullptr) && buf->isPhys()) {
// 		return true;
// 	}
